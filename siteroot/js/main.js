...
var _user$project$Main$viewConfig = function () {
	var customizedLi = F3(
		function (keySelected, mouseSelected, brewery) {
			return {
				attributes: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(brewery.title),
						_1: {ctor: '[]'}
					}
				},
				children: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(brewery.title),
					_1: {ctor: '[]'}
				}
			};
		});
...
var _user$project$Main$resetMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{autoState: _thebritican$elm_autocomplete$Autocomplete$empty, showMenu: false});
};
var _user$project$Main$removeSelection = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedBrewery: _elm_lang$core$Maybe$Nothing});
};
var _user$project$Main$resetInput = function (model) {
	return _user$project$Main$resetMenu(
		_user$project$Main$removeSelection(
			_elm_lang$core$Native_Utils.update(
				model,
				{query: ''})));
};
		...
		return A2(
			...
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (brewery) {
						return _elm_lang$core$Native_Utils.eq(brewery.title, id);
					},
					breweries)));
	});
var _user$project$Main$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				query: function (_) {
					...
					A2(_user$project$Main$getBreweryAtId, model.breweries, id)),
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {breweries: a, autoState: b, howManyToShow: c, query: d, selectedBrewery: e, showMenu: f};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$OnFocus = {ctor: 'OnFocus'};
var _user$project$Main$PreviewBrewery = function (a) {
	return {ctor: 'PreviewBrewery', _0: a};
};
var _user$project$Main$SelectBreweryMouse = function (a) {
	return {ctor: 'SelectBreweryMouse', _0: a};
};
var _user$project$Main$SelectBreweryKeyboard = function (a) {
	return {ctor: 'SelectBreweryKeyboard', _0: a};
};
var _user$project$Main$HandleEscape = {ctor: 'HandleEscape'};
var _user$project$Main$Reset = {ctor: 'Reset'};
var _user$project$Main$Wrap = function (a) {
...
var _user$project$Main$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		...
		onKeyDown: F2(
			function (code, maybeId) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(_elm_lang$core$Maybe$map, _user$project$Main$PreviewBrewery, maybeId) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(_elm_lang$core$Maybe$map, _user$project$Main$SelectBreweryKeyboard, maybeId) : _elm_lang$core$Maybe$Just(_user$project$Main$Reset));
			}),
		onTooLow: _elm_lang$core$Maybe$Just(
			_user$project$Main$Wrap(false)),
		onTooHigh: _elm_lang$core$Maybe$Just(
			_user$project$Main$Wrap(true)),
		...
		onMouseClick: function (id) {
			return _elm_lang$core$Maybe$Just(
				_user$project$Main$SelectBreweryMouse(id));
		},
			...
			switch (_p2.ctor) {
				...
				case 'HandleEscape':
					var validOptions = !_elm_lang$core$List$isEmpty(
						A2(_user$project$Main$acceptableBreweries, model.query, model.breweries));
					var handleEscape = validOptions ? _user$project$Main$resetMenu(
						_user$project$Main$removeSelection(model)) : _user$project$Main$resetMenu(
						_user$project$Main$removeSelection(
							_elm_lang$core$Native_Utils.update(
								model,
								{query: ''})));
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									autoState: A4(
										...
										model.howManyToShow,
										model.autoState),
									selectedBrewery: _elm_lang$core$List$head(
				...
				case 'Reset':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								autoState: A2(_thebritican$elm_autocomplete$Autocomplete$reset, _user$project$Main$updateConfig, model.autoState),
								selectedBrewery: _elm_lang$core$Maybe$Nothing
							}),
						{ctor: '[]'});
...
var _user$project$Main$view = function (model) {
	...
	var dec = A2(
		...
		A2(
			_elm_lang$core$Json_Decode$map,
			function (code) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(_user$project$Main$NoOp) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(_user$project$Main$HandleEscape) : _elm_lang$core$Result$Err('We can\'t handle that key.'));
			},
